import 'package:dalgeurak_meal_application/pages/teacher_meal_exception/widgets/choice_user_container.dart';
...
class MultipleStudentChoice extends BasicStudentSearch {
    ...
    return [
      Center(
        child: GestureDetector(
          onTap: () => Get.toNamed(DalgeurakMealApplicationRoutes.MEALEXCEPTION, arguments: {"studentList": selectStudentList}),
          child: Container(
            width: 55,
            height: 33,
